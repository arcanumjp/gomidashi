...
public class CalendarView extends LinearLayout {
    ...
    /**
     * コンストラクタ
     * @param activity 親のコンテキストをセット
     */
    public CalendarView(Activity activity) {
       super(activity.getApplicationContext());
        _parent = activity;
       this.init(activity.getApplicationContext(), null);
    }
     ...
     */
    /*
    public CalendarView(Activity activity, AttributeSet attrs) {
       super(activity.getApplicationContext(), attrs);
       this.init(activity.getApplicationContext(), attrs);
    }
    */
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        {
            //カレンダービューの追加
            this.mViewPrevious = new MonthlyCalendarView(_parent);
            ...
            //カレンダービューの追加
            this.mViewNext = new MonthlyCalendarView(_parent);
